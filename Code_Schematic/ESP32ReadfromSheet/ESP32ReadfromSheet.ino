...
//---------------------------------------------------------------------
const char * ssid = "4GModem"; // Type your wifi password
const char * password = "12345678abc"; // Type your wifi password
String GOOGLE_SCRIPT_ID = "AKfycbzDWuQy0u5byRGIN_gRi2fBDCX7nlgOOL9tMWcG_VZRK2EQtZ88FG0gGsYb4dR55K4"; // google script id
//---------------------------------------------------------------------
